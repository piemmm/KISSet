package org.prowl.kissetgui.services.host.parser.guicommands;
...
import org.prowl.kissetgui.userinterface.desktop.terminals.DebugTerminal;
import org.prowl.kissetgui.userinterface.desktop.terminals.PlainTextTerminal;
import org.prowl.kissetgui.userinterface.desktop.terminals.TeletextTerminal;
...
public class Term extends Command {
    ...
    public boolean doCommand(String[] data) throws IOException {
        ...
        if (data.length == 1) {
            writeToTerminal("Terminal type: " + tncHost.getTerminalType() + CR);
            return true;
        }
...
//                break;
        ...
        writeToTerminal("Terminal changed to " + tncHost.getTerminalType() + CR);
