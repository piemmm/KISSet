...
public class SymbolCache {
    ...
    private static final Image primary = new Image(KISSetGUI.class.getResourceAsStream("img/aprs0.png"));
    private static final Image alternate = new Image(KISSetGUI.class.getResourceAsStream("img/aprs1.png"));
