...
/**
 * Set the persistence KISS parameter
 */
@TNCCommand
public class Persistence extends Command {
    ...
    public boolean doCommand(String[] data) throws IOException {
        ...
        if (data.length == 1) {
            Disp.showValue(this, "PERsistence", Disp.getKissParameterValue(commandParser, KissParameterType.PERSISTENCE));
        } else {
            ...
            commandParser.getCurrentInterface().setKissParameter(KissParameterType.PERSISTENCE, value);
            ...
            iConfig.setProperty(Conf.persistence.name(), value);
            config.saveConfig();
    ...
    public String[] getCommandNames() {
        return new String[]{"per","persist", "persistence"};
    }
