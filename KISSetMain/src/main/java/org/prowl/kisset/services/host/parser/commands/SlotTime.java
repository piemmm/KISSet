...
/**
 * Set the SlotTime KISS parameter
 */
@TNCCommand
public class SlotTime extends Command {
    ...
    public boolean doCommand(String[] data) throws IOException {
        ...
        if (data.length == 1) {
            Disp.showValue(this, "SLOTtime", Disp.getKissParameterValue(commandParser, KissParameterType.SLOT_TIME));
        } else {
            ...
            commandParser.getCurrentInterface().setKissParameter(KissParameterType.SLOT_TIME, value);
            ...
            iConfig.setProperty(Conf.slotTime.name(), value);
            config.saveConfig();
    ...
    public String[] getCommandNames() {
        return new String[]{"slot", "slottime"};
    }
