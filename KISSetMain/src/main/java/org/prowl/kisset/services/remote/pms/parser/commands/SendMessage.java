    ...
    public boolean doCommand(String[] data) throws IOException {
        ...
        if (mode.equals(Mode.CMD) && data[0].length() > 0) {
            if (data[0].equals("sb") || data[0].equals("sendb")) {
                ...
                messageState = null;
                setMode(org.prowl.kisset.services.remote.pms.parser.Mode.SENDING_PUBLIC_MESSAGE);
                buildMessage(data);
                return true;
    ...
    public void buildMessage(String[] data) throws IOException {
        ...
        if (MessageState.GET_CONFIRMATION.equals(messageState)) {
            ...
            if (confirmation.equalsIgnoreCase("y")) {
                ...
                write("*** Invalid confirmation" + CR);
                write("Do you wish to send this message? (y/n): ");
            }
        }
