...
public class NetROMUserClientHandler implements ClientHandler {

    private static final Log LOG = LogFactory.getLog("NetROMUserClientHandler");
    ...
    public NetROMUserClientHandler(Interface anInterface, User user, InputStream in, OutputStream out) {
        this.in = in;
        this.out = out;
        this.user = user;
